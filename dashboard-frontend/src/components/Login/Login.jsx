...
const LoginPage = () => {
  ...
  return (
    <Box
    bg="linear-gradient(to bottom right, #1E3A8A, #3B82F6)" 
    minH="100vh"
      display="flex"
    ...
    >
      <Container
        ...
        textAlign="center"
      >
        <h1 style={{ color: 'white' }}>Welcome, Manobhiram Bhatter!</h1>
        <form>
          <FormControl>
          ...
          <AlertDialog isOpen={isOpen} leastDestructiveRef={undefined}>
            ...
            <AlertDialogContent bg="blue.800" color="white">
                <AlertDialogHeader>Welcome, Manobhiram Bhatter!</AlertDialogHeader>
                <AlertDialogBody>
